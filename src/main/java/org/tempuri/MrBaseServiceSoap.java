...
public interface MrBaseServiceSoap {
     ...
     */
    @WebMethod(action = "http://tempuri.org/getUsernameByTicket")
    @WebResult(name = "getUsernameByTicketResult", targetNamespace = "http://tempuri.org/")
    @RequestWrapper(localName = "getUsernameByTicket", targetNamespace = "http://tempuri.org/", className = "org.tempuri.GetUsernameByTicket")
    @ResponseWrapper(localName = "getUsernameByTicketResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.GetUsernameByTicketResponse")
    public String getUsernameByTicket(
